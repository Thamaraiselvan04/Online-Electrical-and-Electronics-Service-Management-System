...
<body>
    ...
    <p class="text-center" style="font-size:20px;"><i class ="fas fa-user-secret text-danger"></i>Requester Forget Password Area</p>
    <div class="container-fluid">
        <div class="row justify-content-center custom-margin">
            <div class="col-sm-6 col-md-4">
                <form action="forget.php" class="shadow-lg p-4" method="GET">
                    <div class="form-group">
                    <i class="fas fa-user"></i><label for="email" class="font-weight-bold pl-2">Email</label>
                    <input type="email"
                    class="form-control" placeholder="Enter your Registered Email" name="rEmail">
                    ...
                    <a href="forget.php" class="btn btn-outline-success mt-3
                     font-weight-bold shadow-sm" >Forget password</a>
                     </div>
                    <?php if(isset($msg))
                    {
                        echo $msg;
